...
class __TwigTemplate_c3e5b325558be193829bc7638f610a8ca6fa63bb6c9e12a366fcf09e4e7bef72 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <a href=\"/categories\">Toutes les catégories</a> >
    <a href=\"/category/";
        // line 7
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 7, $this->source); })()), "name", [], "any", false, false, false, 7), "html", null, true);
        echo "</a> > <a href=\"/post/";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 7, $this->source); })()), "slug", [], "any", false, false, false, 7), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 7, $this->source); })()), "slug", [], "any", false, false, false, 7), "html", null, true);
        echo "</a>
    <h1>";
    ...
    <p>";
        // line 12
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 12, $this->source); })()), "createdAt", [], "any", false, false, false, 12), "d/m/Y à H:i"), "html", null, true);
        echo "</p>
";
    ...
    {
        return array (  112 => 12,  107 => 10,  102 => 8,  92 => 7,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mon blog - {{post.title}}{% endblock %}

{% block body %}
    <a href=\"/categories\">Toutes les catégories</a> >
    <a href=\"/category/{{category.name}}\">{{category.name}}</a> > <a href=\"/post/{{post.slug}}\">{{post.slug}}</a>
    <h1>{{post.title}}</h1>

    <p>{{post.content}}</p>

    <p>{{ post.createdAt|date(\"d/m/Y à H:i\") }}</p>
{% endblock %}
", "post/index.html.twig", "C:\\wamp64\\www\\Workspace\\symfony\\my_blog\\templates\\post\\index.html.twig");
    }
}
